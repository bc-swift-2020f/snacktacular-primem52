...
class SpotDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupMapView()
        reviews = Reviews() // eventually loads review object
        updateUserInterface()
    ...
    @IBAction func ratingButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This venue has not been saved", message: "Must save first", segueIdentifier: "AddReview")
        }
        else{
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This venue has not been saved", message: "Must save first", segueIdentifier: "AddPhoto")
        }
        else{
